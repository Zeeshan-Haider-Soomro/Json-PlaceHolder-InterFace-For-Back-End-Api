...
const Hero = () => {
  return (
    <>
        <div className='m-[180px] leading-10'>
        ...
        <div className='m-[180px] leading-10'>
            ...
            <img className='h-[150px] w-[850px] rounded-xl my-5' src="/images/code.png" alt="" />
            <button className='bg-black text-white rounded-sm px-3 font-bold'>Run Script</button>
            <img className='h-[150px] w-[850px] rounded-xl my-5' src="/images/image.png" alt="" />
            <p>Congrats! You've made your first call to JSONPlaceholder. 😃 🎉</p>
            <img className='h-[150px] w-[450px] rounded-xl my-5' src="/images/coding.png" alt="" />
        </div>
        <div className='m-[180px] leading-10 '>
        ...
        <div className='m-[180px] leading-10'>
            ...
            <p><span className='font-bold'>Note</span>: resources have relations. For example: posts have many comments, albums have many photos, ... see guide for the full list.</p>
        </div>
    </>
  )
}
